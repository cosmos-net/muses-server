import { EnvironmentEnum } from '@core/domain/contracts/enums/environment.enum';
import { VarEnvMapConfigType } from '@core/domain/contracts/types/var-environment-map/var-env-map-config.type';
