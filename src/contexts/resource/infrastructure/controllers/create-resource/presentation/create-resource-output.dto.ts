...
export interface ICreateResourceOutputDto {
  id: string | any;
  name: string;
  description: string;
  isEnabled: boolean;
...
export class CreateResourceOutputDto implements ICreateResourceOutputDto {
  id: string;
  name: string;
  description: string;
  isEnabled: boolean;
  ...
  constructor(root: ICreateResourceOutputDto) {
    this.id = root.id;
    this.name = root.name;
